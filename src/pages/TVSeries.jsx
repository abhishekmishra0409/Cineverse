            ...
            <div className="mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="text-center mb-8 sm:mb-12">
                    ...
                    <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                        Discover trending TV shows from around the world. Find your next binge-worthy series!
                    </p>
                </div>

                {/* Results Count */}
                {!isLoading && tvSeries.length > 0 && (
                    <div className="flex justify-between items-center mb-6 px-2">
                        <div className="text-sm text-gray-600 dark:text-gray-400">
                            Showing {tvSeries.length} series
                        </div>
                        <div className="text-sm text-gray-600 dark:text-gray-400">
                ...
                {isLoading ? (
                    ...
                    <>
                        ...
                        {tvSeries.length > 0 ? (
                            ...
                            ">
                                {tvSeries.map((series) => (
                                    ...
                                    >
                                        <div className="w-[200px] sm:w-[220px] md:w-[240px] lg:w-[250px]">
                                            <MovieCard
                                                id={series.id}
                            ...
                            <div className="flex flex-col items-center justify-center py-20 text-center">
                                ...
                                <p className="text-gray-500 dark:text-gray-500 max-w-md text-lg mb-6">
                                    We couldn't find any TV series matching your criteria.
                        ...
                        {/* Pagination */}
                        {tvSeries.length > 0 && totalPages > 1 && (
                    ...
                    ${page === totalPages
                                ...
                                <div className="hidden sm:block text-sm text-gray-600 dark:text-gray-400">
                                    {tvSeries.length} series per page
                                </div>
                            </div>
                        )}
                    </>
